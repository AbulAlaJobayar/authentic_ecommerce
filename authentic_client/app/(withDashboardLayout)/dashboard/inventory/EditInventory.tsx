    ...
    try {
      const res = await updateInventory({
        ...
        data: {
          ...
          inventory: {
            ...values.inventory,
            alertQuantity: Number(values.inventory.alertQuantity),
          },
        },
      });
      ...
      >
        <FieldGroup>
          <Field>
            ...
            <ATSInput name="product.name" id="product.name" type="text" />
          </Field>

          <Field>
            <FieldLabel htmlFor="product.sku">SKU</FieldLabel>

            <ATSInput name="product.sku" id="product.sku" type="text" />
          </Field>
